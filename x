...
=== RUN   TestComposite_Tick/multiple_conditions,_first_running
    behaviortree_test.go:406: 
        Composite (Running)
          ...
          Condition[1]: Condition (Ready)
          Child: Action (Ready)
--- FAIL: TestComposite_Tick (0.00s)
    --- FAIL: TestComposite_Tick/no_conditions_or_child (0.00s)
    --- FAIL: TestComposite_Tick/no_conditions,_child_succeeds (0.00s)
    --- FAIL: TestComposite_Tick/no_conditions,_child_fails (0.00s)
    --- FAIL: TestComposite_Tick/single_condition_succeeds,_no_child (0.00s)
    --- FAIL: TestComposite_Tick/single_condition_succeeds,_child_succeeds (0.00s)
    --- FAIL: TestComposite_Tick/single_condition_succeeds,_child_fails (0.00s)
    --- FAIL: TestComposite_Tick/single_condition_fails,_child_not_executed (0.00s)
    --- FAIL: TestComposite_Tick/single_condition_running (0.00s)
    --- FAIL: TestComposite_Tick/multiple_conditions_all_succeed,_child_succeeds (0.00s)
    --- FAIL: TestComposite_Tick/multiple_conditions,_first_fails (0.00s)
    --- FAIL: TestComposite_Tick/multiple_conditions,_second_fails (0.00s)
    --- FAIL: TestComposite_Tick/multiple_conditions,_first_running (0.00s)
...
2025/09/03 15:28:41 WARN Log node has no child status=Failure
=== RUN   TestLog_Tick/child_succeeds
2025/09/03 15:28:41 INFO Success test child_status=Success child_type=Action
=== RUN   TestLog_Tick/child_fails
2025/09/03 15:28:41 WARN Failure test child_status=Failure child_type=Action
=== RUN   TestLog_Tick/child_running
=== RUN   TestLog_Tick/empty_message
2025/09/03 15:28:41 INFO Log node executed child_status=Success child_type=Action
...
2025/09/03 15:28:41 INFO Execution test child_status=Success child_type=Action
2025/09/03 15:28:41 INFO Execution test child_status=Success child_type=Action
--- PASS: TestLog_ChildExecution (0.00s)
=== RUN   TestLog_Reset
2025/09/03 15:28:41 INFO Reset test child_status=Success child_type=Action
--- PASS: TestLog_Reset (0.00s)
=== RUN   TestLog_String
=== RUN   TestLog_String/no_child
=== RUN   TestLog_String/with_child_and_message
2025/09/03 15:28:41 INFO Action log child_status=Success child_type=Action
...
2025/09/03 15:28:41 INFO Test logging child_status=Success child_type=Action
=== RUN   TestLog_LoggingBehavior/Failure_logging
2025/09/03 15:28:41 WARN Test logging child_status=Failure child_type=Action
...
2025/09/03 15:28:41 ERROR Custom level test child_status=Success child_type=Action
=== RUN   TestLog_CustomLogLevel/custom_info_level_for_failure
2025/09/03 15:28:41 INFO Info level failure child_status=Failure child_type=Action
=== RUN   TestLog_CustomLogLevel/custom_debug_level_for_running
=== RUN   TestLog_CustomLogLevel/nil_log_level_uses_defaults
2025/09/03 15:28:41 INFO Default level test child_status=Success child_type=Action
...
2025/09/03 15:28:41 ERROR Log node has no child status=Failure
...
2025/09/03 15:28:41 ERROR Error level test child_status=Success child_type=Action
...
2025/09/03 15:28:41 INFO Reset test with custom level child_status=Success child_type=Action
2025/09/03 15:28:41 INFO Log node reset message="Reset test with custom level"
--- PASS: TestLog_ResetWithCustomLevel (0.00s)
=== RUN   TestComplexBehaviorTreeWithLog
2025/09/03 15:28:41 WARN Monitoring critical action child_status=Failure child_type=Action
2025/09/03 15:28:41 WARN Monitoring critical action child_status=Failure child_type=Action
2025/09/03 15:28:41 INFO Monitoring critical action child_status=Success child_type=Action
--- PASS: TestComplexBehaviorTreeWithLog (0.00s)
FAIL
exit status 1
FAIL	github.com/rbrabson/behave	0.193s
